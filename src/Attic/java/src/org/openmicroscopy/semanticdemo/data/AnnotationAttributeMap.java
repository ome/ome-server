/*
 * org.openmicroscopy.semanticdemo.data.AnnotationAttributeMap
 *
 *------------------------------------------------------------------------------
 *
 ...
 */
public class AnnotationAttributeMap extends AttributeMap
{

  public AnnotationAttributeMap(Factory factory, Dataset dataset)
  {
    ...
    for(int i=0;i<datasetTypes.length;i++)
    {
      for(int j=0;j<visualizations.size();j++)
      {
        ...
        {
          if(v.getDisplayType() == Visualization.DisplayType.ANNOTATION)
          {
  ...
  public AnnotationAttributeMap(Factory factory, Image image)
  {
    DBVisualizationFactory visFactory =
      DBVisualizationFactory.getInstance(factory);
  ...
  public AnnotationAttributeMap(Factory factory, Feature feature)
  {
    DBVisualizationFactory visFactory =
      DBVisualizationFactory.getInstance(factory);
