/*
 * org.openmicroscopy.vis.piccolo.PModuleZoomEventHandler
 *
 *------------------------------------------------------------------------------
 *
...
public class PModuleZoomEventHandler extends  PBasicInputEventHandler {
	...
	public PModuleZoomEventHandler(PBufferedObject canvas) {
		super();
		this.canvas = canvas;		
	}
