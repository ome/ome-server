/*
 * org.openmicroscopy.browser.layout.CriteriaGroupingMethod
 *
 *------------------------------------------------------------------------------
 *
...
import org.openmicroscopy.browser.util.GrepOperator;
...
public class CriteriaGroupingMethod implements GroupingMethod
{
   ...
   * @see org.openmicroscopy.browser.layout.GroupingMethod#assignGroup(org.openmicroscopy.browser.images.Thumbnail)
   */
   ...
   * @see org.openmicroscopy.browser.layout.GroupingMethod#getGroup(org.openmicroscopy.browser.images.Thumbnail)
   */
