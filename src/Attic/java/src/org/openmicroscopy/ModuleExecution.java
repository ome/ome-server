 ...
 * eligible for reuse.  Each <code>Analysis</code> has a dependence of
 ...
 * of this <code>Analysis</code> to be reused, even if the dataset
 ...
 * created by a dataset-dependent <code>Analysis</code> could only be
    ...
    extends OMEObject
{
    ...
    /**
     * Returns a list of all of the {@link Analysis.ActualInput
     * ActualInputs} associated with this analysis.
     * @return a {@link List} of {@link Analysis.ActualInput
     * ActualInputs}
     */
    public List getInputs();

    /**
     * Returns an iterator of all of the {@link Analysis.ActualInput
     * ActualInputs} associated with this analysis.
     * @return an {@link Iterator} of {@link Analysis.ActualInput
     * ActualInputs}
     */
     ...
     *
     * <p>The module's input is specified by the <code>Analysis</code>
