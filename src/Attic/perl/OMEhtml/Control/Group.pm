# Group.pm:  Site-wide HTML template functions
...
sub getHTMLArray {
    my $self = shift;
    my @html;
    foreach my $control (@{$self->{children}}) {
	push @html,  $control->getHTML();
    }
    return @html;
}
