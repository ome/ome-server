...
void DumpDVHeader( DVhead *head, FILE *fp )
{
	...
	fprintf (fp,"%-14s: %5ld\n","Width (X)",head->numCol);
	fprintf (fp,"%-14s: %5ld\n","Height (Y)",head->numRow);
	fprintf (fp,"%-14s: %5ld\n","Depth (Z)",head->numImages / (head->NumWaves * head->numtimes));
	fprintf (fp,"%-14s: %8.5f\n","Pixel size X",head->xlen);
	fprintf (fp,"%-14s: %8.5f\n","Pixel size Y",head->ylen);
	fprintf (fp,"%-14s: %8.5f\n","Pixel size Z",head->zlen);
	fprintf (fp,"%-14s: %5d\n","Wavelengths",head->NumWaves);
	fprintf (fp,"%-14s: %5d\n","Wavelength 1",head->iwav1);
	fprintf (fp,"%-14s: %5d\n","Wavelength 2",head->iwav2);
	fprintf (fp,"%-14s: %5d\n","Wavelength 3",head->iwav3);
	fprintf (fp,"%-14s: %5d\n","Wavelength 4",head->iwav4);
	fprintf (fp,"%-14s: %5d\n","Wavelength 5",head->iwav5);
	fprintf (fp,"%-14s: %5d\n","Timepoints",head->numtimes);
