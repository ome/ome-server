...
void num2color(int color,char *color_name)
{
  ...
  strcpy(color_name,colors[color].name);
}
...
{  int FunctionCounter=0;
   ...
   {  if (color_index==color_functions[FunctionCounter].color)
      {  if (!res && (color<color_functions[FunctionCounter].start || color>color_functions[FunctionCounter].end)) res=0;           /* out of the range */
         else
         if (!res && color>=color_functions[FunctionCounter].maximum1 && color<=color_functions[FunctionCounter].maximum2) res=1; /* the top of the trapez maximum */
         else
         if (!res && color<color_functions[FunctionCounter].maximum1) res=(color-color_functions[FunctionCounter].start)/(color_functions[FunctionCounter].maximum1-color_functions[FunctionCounter].start);
         else
         if (!res && color>color_functions[FunctionCounter].maximum2) res=1-(color-color_functions[FunctionCounter].maximum2)/(color_functions[FunctionCounter].end-color_functions[FunctionCounter].maximum2);
         if (res>0) return(res);
      }
      FunctionCounter++;
   }
...
float grey_value(float value)
{
   ...
   return(1-((value-GREY_MAX)/(GREY_END-GREY_MAX)));
}
...
float almost_grey_value(float value)
{
   ...
   return(1-((value-ALMOST_GREY_MAX)/(ALMOST_GREY_END-ALMOST_GREY_MAX)));
}
...
float tend_grey_value(float value)
{
   ...
   return(1-((value-TEND_GREY_MAX)/(TEND_GREY_END-TEND_GREY_MAX)));
}
...
float medium_grey_value(float value)
{
   ...
   return(1-((value-MEDIUM_GREY_MAX)/(MEDIUM_GREY_END-MEDIUM_GREY_MAX)));
}
...
float tend_clear_value(float value)
{
   ...
   return(1-((value-TEND_CLEAR_MAX)/(TEND_CLEAR_END-TEND_CLEAR_MAX)));
}
...
float clear_value(float value)
{
   ...
   return(1-((value-CLEAR_MAX)/(CLEAR_END-CLEAR_MAX)));
}
...
float dark_value(float value)
{
   ...
   return(1-((value-DARK_MAX)/(DARK_END-DARK_MAX)));
}
...
float almost_dark_value(float value)
{
   ...
   return(1-((value-ALMOST_DARK_MAX)/(ALMOST_DARK_END-ALMOST_DARK_MAX)));
}
...
float tend_dark_value(float value)
{
   ...
   return(1-((value-TEND_DARK_MAX)/(TEND_DARK_END-TEND_DARK_MAX)));
}
...
float tend_light_value(float value)
{
   ...
   return(1-((value-TEND_LIGHT_MAX)/(TEND_LIGHT_END-TEND_LIGHT_MAX)));
}
...
float light_value(float value)
{
   ...
   return(1-((value-LIGHT_MAX)/(LIGHT_END-LIGHT_MAX)));
}
...
float hue_red_value(float value)
{
   ...
   return(1-((value-HUE_RED_MAX)/(HUE_RED_END-HUE_RED_MAX)));
}
...
float hue_dark_orange_value(float value)
{
   ...
   return(1-((value-HUE_DARK_ORANGE_MAX2)/(HUE_DARK_ORANGE_END-HUE_DARK_ORANGE_MAX2)));
}
...
float hue_light_orange_value(float value)
{
   ...
   return(1-((value-HUE_LIGHT_ORANGE_MAX2)/(HUE_LIGHT_ORANGE_END-HUE_LIGHT_ORANGE_MAX2)));
}
...
float hue_yellow_value(float value)
{
   ...
   return(1-((value-HUE_YELLOW_MAX)/(HUE_YELLOW_END-HUE_YELLOW_MAX)));
}
//---------------------------------------------------------------------------
