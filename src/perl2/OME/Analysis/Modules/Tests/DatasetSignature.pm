# OME/Analysis/Modules/Tests/DatasetSignature.pm
...
package OME::Analysis::Modules::Tests::DatasetSignature;
...
sub execute {
    ...
    my $signatures = OME::Tasks::ModuleExecutionManager->
      getAttributesForMEX(\@input_mexes,$formal_input->semantic_type());
