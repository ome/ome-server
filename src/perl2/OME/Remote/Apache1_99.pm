package OME::Remote::Apache1_99;

use strict;
use vars qw(@ISA $VERSION);
use XMLRPC::Transport::HTTP;

use base qw(OME::Remote::Apache1_99::HTTPProxy);
...
OME::Remote::Apache2 - mod_perl2-based XML-RPC server with minimum configuration
...
=head1 SEE ALSO
 ...
 OME::Remote::Apache for a mod_perl 1.0 implementation
 Apache::XMLRPC::Lite for the original implementation
