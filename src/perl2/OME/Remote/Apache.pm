package OME::Remote::Apache;

use strict;
use vars qw(@ISA $VERSION);
use XMLRPC::Transport::HTTP;

use base qw(OME::Remote::Apache::HTTPProxy);
...
OME::Remote::Apache - mod_perl-based XML-RPC server with minimum configuration
...
=head1 SEE ALSO
 ...
 OME::Remote::Apache2 for a mod_perl 2.0 implementation
