...
package OME::Web::Search::OME_Module;

=pod

=head1 NAME

OME::Web::Search::OME_Module - Specialized rendering for Modules
...
returns a dropdown list of Module names.
