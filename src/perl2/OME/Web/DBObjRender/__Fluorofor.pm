# OME/Web/DBObjRender/__Fluorofor.pm
#-------------------------------------------------------------------------------
#
...
package OME::Web::DBObjRender::__Fluorofor;
use strict;
use OME;
...
OME::Web::DBObjRender::__Fluorofor - Specialized rendering for Fluorofor Attributes
