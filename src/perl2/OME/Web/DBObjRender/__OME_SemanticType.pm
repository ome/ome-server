# OME/Web/RenderData/__OME_SemanticType.pm
#-------------------------------------------------------------------------------
#
...
package OME::Web::RenderData::__OME_SemanticType;

=pod

=head1 NAME

OME::Web::RenderData::__OME_SemanticType - Specialized rendering for OME::SemanticType

=head1 DESCRIPTION

Provides custom behavior for rendering an OME::SemanticType
