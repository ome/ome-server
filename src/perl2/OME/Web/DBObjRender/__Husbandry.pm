# OME/Web/DBObjRender/__Husbandry.pm
#-------------------------------------------------------------------------------
#
...
package OME::Web::DBObjRender::__Husbandry;
use strict;
use OME;
...
OME::Web::DBObjRender::__Husbandry - Specialized rendering for Husbandry Attributes
