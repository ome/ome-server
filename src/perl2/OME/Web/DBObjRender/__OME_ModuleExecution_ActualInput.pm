# OME/Web/DBObjRender/__OME_ModuleExecution_ActualInput.pm
#-------------------------------------------------------------------------------
#
...
package OME::Web::DBObjRender::__OME_ModuleExecution_ActualInput;

=pod

=head1 NAME

OME::Web::DBObjRender::__OME_ModuleExecution_ActualInput -
Specialized rendering for OME::ModuleExecution::ActualInput

=head1 DESCRIPTION

Provides custom behavior for rendering an OME::ModuleExecution::ActualInput
