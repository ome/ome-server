...
provide by the
L<C<OME::AttributeType::Superclass>|OME::AttributeType>
class.
...
L<C<OME::AttributeType::Superclass>|OME::AttributeType> classes
...
C<ATTRIBUTE_TYPES> (L<C<OME::AttributeType>|OME::AttributeType>)

=item *

C<ATTRIBUTE_COLUMNS> (L<C<OME::AttributeType::Column>|OME::AttributeType>)
...
L<C<OME::AttributeType::Superclass>|OME::AttributeType> for the
