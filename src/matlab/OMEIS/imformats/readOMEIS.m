...
% This function is an implementation of MATLAB's imread function for
% OMEIS based files
function [X, map, alpha] = readOMEIS(filename, extraArgs);
...
map = [];
aplha = [];
X = getPixels (openConnectionOMEIS(url), id);
return;