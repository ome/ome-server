...
public class ExFilterNode extends FilterSpecNode
{
	...
	/** Constructs a ExFilter node with an associated DOM element. */
	 ...
	 * a given parent.
	 */
	public ExFilterNode(OMEXMLNode parent)
	{
		this(parent, true);
	}
	 ...
	 * a given parent.
	 */
	public ExFilterNode(OMEXMLNode parent, boolean attach)
	{
		super(DOMUtil.createChild(parent.getDOMElement(),
		                          "ExFilter", attach));
	}

	// -- ExFilter API methods --
