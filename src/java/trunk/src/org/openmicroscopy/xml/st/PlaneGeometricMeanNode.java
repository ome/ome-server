/*
 * org.openmicroscopy.xml.PlaneGeometricMeanNode
 *
 *-----------------------------------------------------------------------------
 *
...
/**
 * PlaneGeometricMeanNode is the node corresponding to the
 * "PlaneGeometricMean" XML element.
 *
 * Name: PlaneGeometricMean
 * AppliesTo: I
 * Location: OME/src/xml/OME/Import/ImageServerStatistics.ome
 */
public class PlaneGeometricMeanNode extends AttributeNode
  implements PlaneGeometricMean
{

  // -- Constructors --

  /**
   * Constructs a PlaneGeometricMean node
   * with the given associated DOM element.
   */
  public PlaneGeometricMeanNode(Element element) { super(element); }
   ...
   * given parent.
   */
  public PlaneGeometricMeanNode(OMEXMLNode parent) {
    this(parent, true);
  }
   ...
   * given parent.
   */
  public PlaneGeometricMeanNode(OMEXMLNode parent, boolean attach) {
   ...
   */
  public PlaneGeometricMeanNode(OMEXMLNode parent, Integer theZ, Integer theC,
  ...
  // -- PlaneGeometricMean API methods --

  /**
   * Gets TheZ attribute
   * of the PlaneGeometricMean element.
   */
  ...
  /**
   * Sets TheZ attribute
   * for the PlaneGeometricMean element.
   */
