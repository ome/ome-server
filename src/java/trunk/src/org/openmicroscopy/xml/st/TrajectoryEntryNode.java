  ...
  implements TrajectoryEntry
{
   ...
   * given parent.
   */
  public TrajectoryEntryNode(CustomAttributesNode parent) {
    this(parent, true);
  }
  ...
  public TrajectoryEntryNode(CustomAttributesNode parent,
    boolean attach)
  {
    super(parent, "TrajectoryEntry", attach);
  }
   ...
   */
  public TrajectoryEntryNode(CustomAttributesNode parent,
    Trajectory trajectory, Integer order, Float deltaX, Float deltaY,
    Float deltaZ, Float distance, Float velocity)
  {
    this(parent, true);
