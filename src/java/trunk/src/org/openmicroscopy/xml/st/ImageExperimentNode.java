  ...
  implements ImageExperiment
{
   ...
   * given parent.
   */
  public ImageExperimentNode(OMEXMLNode parent) {
    this(parent, true);
  }
   ...
   * given parent.
   */
  public ImageExperimentNode(OMEXMLNode parent, boolean attach) {
   ...
   */
  public ImageExperimentNode(OMEXMLNode parent, Experiment experiment)
  {
    this(parent, true);
