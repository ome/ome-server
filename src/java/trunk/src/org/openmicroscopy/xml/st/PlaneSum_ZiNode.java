  ...
  implements PlaneSum_Zi
{
   ...
   * given parent.
   */
  public PlaneSum_ZiNode(CustomAttributesNode parent) {
    this(parent, true);
  }
  ...
  public PlaneSum_ZiNode(CustomAttributesNode parent,
    boolean attach)
  {
    super(parent, "PlaneSum_Zi", attach);
  }
   ...
   */
  public PlaneSum_ZiNode(CustomAttributesNode parent, Integer theZ,
    Integer theC, Integer theT, Float sum_Zi)
  {
    this(parent, true);
    setTheZ(theZ);
    setTheC(theC);
