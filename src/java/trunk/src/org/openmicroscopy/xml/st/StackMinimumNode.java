  ...
  implements StackMinimum
{
   ...
   * given parent.
   */
  public StackMinimumNode(CustomAttributesNode parent) {
    this(parent, true);
  }
  ...
  public StackMinimumNode(CustomAttributesNode parent,
    boolean attach)
  {
    super(parent, "StackMinimum", attach);
  }
   ...
   */
  public StackMinimumNode(CustomAttributesNode parent, Integer theC,
