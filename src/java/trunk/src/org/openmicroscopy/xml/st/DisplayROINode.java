  ...
  implements DisplayROI
{
   ...
   * given parent.
   */
  public DisplayROINode(CustomAttributesNode parent) {
    this(parent, true);
  }
  ...
  public DisplayROINode(CustomAttributesNode parent,
    boolean attach)
  {
    super(parent, "DisplayROI", attach);
  }
   ...
   */
  public DisplayROINode(CustomAttributesNode parent, Integer x0, Integer y0,
