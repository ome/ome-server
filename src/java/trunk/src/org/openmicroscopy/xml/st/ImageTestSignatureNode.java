  ...
  implements ImageTestSignature
{
   ...
   * given parent.
   */
  public ImageTestSignatureNode(CustomAttributesNode parent) {
    this(parent, true);
  }
  ...
  public ImageTestSignatureNode(CustomAttributesNode parent,
    boolean attach)
  {
    super(parent, "ImageTestSignature", attach);
  }
   ...
   */
  public ImageTestSignatureNode(CustomAttributesNode parent, Float value)
  {
    this(parent, true);
    setValue(value);
  }
