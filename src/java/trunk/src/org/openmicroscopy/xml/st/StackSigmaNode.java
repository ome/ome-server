  ...
  implements StackSigma
{
   ...
   * given parent.
   */
  public StackSigmaNode(OMEXMLNode parent) {
    this(parent, true);
  }
   ...
   * given parent.
   */
  public StackSigmaNode(OMEXMLNode parent, boolean attach) {
    super(parent.getDOMElement().getOwnerDocument().
      createElement("StackSigma"));
   ...
   */
  public StackSigmaNode(OMEXMLNode parent, Integer theC, Integer theT,
    Float sigma)
  {
    this(parent, true);
    setTheC(theC);
