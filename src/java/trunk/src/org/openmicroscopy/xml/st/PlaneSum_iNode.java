  ...
  implements PlaneSum_i
{
   ...
   * given parent.
   */
  public PlaneSum_iNode(OMEXMLNode parent) {
    this(parent, true);
  }
   ...
   * given parent.
   */
  public PlaneSum_iNode(OMEXMLNode parent, boolean attach) {
    super(parent.getDOMElement().getOwnerDocument().
      createElement("PlaneSum_i"));
   ...
   */
  public PlaneSum_iNode(OMEXMLNode parent, Integer theZ, Integer theC,
    Integer theT, Float sum_i)
  {
    this(parent, true);
    setTheZ(theZ);
    setTheC(theC);
