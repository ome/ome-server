  ...
  implements FilenamePattern
{
   ...
   * given parent.
   */
  public FilenamePatternNode(CustomAttributesNode parent) {
    this(parent, true);
  }
  ...
  public FilenamePatternNode(CustomAttributesNode parent,
    boolean attach)
  {
    super(parent, "FilenamePattern", attach);
  }
   ...
   */
  public FilenamePatternNode(CustomAttributesNode parent, String format,
    String regEx, String name, String baseName, Integer theZ, Integer theT,
    Integer theC)
  {
    this(parent, true);
    setFormat(format);
