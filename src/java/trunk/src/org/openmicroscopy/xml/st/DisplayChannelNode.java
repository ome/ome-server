  ...
  implements DisplayChannel
{
   ...
   * given parent.
   */
  public DisplayChannelNode(CustomAttributesNode parent) {
    this(parent, true);
  }
  ...
  public DisplayChannelNode(CustomAttributesNode parent,
    boolean attach)
  {
    super(parent, "DisplayChannel", attach);
  }
   ...
   */
  public DisplayChannelNode(CustomAttributesNode parent, Integer channelNumber,
