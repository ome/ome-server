  ...
  implements PlaneMaximum
{
   ...
   * given parent.
   */
  public PlaneMaximumNode(CustomAttributesNode parent) {
    this(parent, true);
  }
  ...
  public PlaneMaximumNode(CustomAttributesNode parent,
    boolean attach)
  {
    super(parent, "PlaneMaximum", attach);
  }
   ...
   */
  public PlaneMaximumNode(CustomAttributesNode parent, Integer theZ,
    Integer theC, Integer theT, Integer maximum)
  {
    this(parent, true);
    setTheZ(theZ);
    setTheC(theC);
