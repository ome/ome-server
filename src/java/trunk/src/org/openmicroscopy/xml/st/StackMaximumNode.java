  ...
  implements StackMaximum
{
   ...
   * given parent.
   */
  public StackMaximumNode(OMEXMLNode parent) {
    this(parent, true);
  }
   ...
   * given parent.
   */
  public StackMaximumNode(OMEXMLNode parent, boolean attach) {
   ...
   */
  public StackMaximumNode(OMEXMLNode parent, Integer theC, Integer theT,
    Integer maximum)
  {
    this(parent, true);
    setTheC(theC);
