  ...
  implements PlaneCentroid
{
   ...
   * given parent.
   */
  public PlaneCentroidNode(OMEXMLNode parent) {
    this(parent, true);
  }
   ...
   * given parent.
   */
  public PlaneCentroidNode(OMEXMLNode parent, boolean attach) {
    super(parent.getDOMElement().getOwnerDocument().
      createElement("PlaneCentroid"));
   ...
   */
  public PlaneCentroidNode(OMEXMLNode parent, Integer theZ, Integer theC,
    Integer theT, Float x, Float y)
  {
    this(parent, true);
    setTheZ(theZ);
    setTheC(theC);
