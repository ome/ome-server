/*
 * org.openmicroscopy.ds.st.PlaneSum_log_iDTO
 *
 *------------------------------------------------------------------------------
 *
...
public class PlaneSum_log_iDTO
    extends AttributeDTO
    implements PlaneSum_log_i
{
    public PlaneSum_log_iDTO() { super(); }
    public PlaneSum_log_iDTO(Map elements) { super(elements); }
    ...
    { setElement("Sum_log_i",new Float(value)); }
