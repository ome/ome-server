/*
 * org.openmicroscopy.ds.st.StackGeometricSigmaDTO
 *
 *------------------------------------------------------------------------------
 *
...
public class StackGeometricSigmaDTO
    extends AttributeDTO
    implements StackGeometricSigma
{
    public StackGeometricSigmaDTO() { super(); }
    public StackGeometricSigmaDTO(Map elements) { super(elements); }
