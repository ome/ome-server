/*
 * org.openmicroscopy.xml2007.MicrobeamManipulationNode
 *
 *-----------------------------------------------------------------------------
 *
...
public class MicrobeamManipulationNode extends OMEXMLNode {
  ...
  public MicrobeamManipulationNode(Element element) { super(element); }

  // -- MicrobeamManipulationNode API methods --
