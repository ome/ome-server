...
public final class SampleTest {
  ...
  public static void testSample(OMENode ome) throws Exception {
    ...
    ROINode imageDisplayOptionsROI =
      imageDisplayOptions.getROI();
    checkNotNull("Image DisplayOptions ROI",
      imageDisplayOptionsROI);
    ...
    Boolean imageDisplayOptionsRedChannelisOn =
      imageDisplayOptionsRedChannel.isisOn();
    ...
    Boolean imageDisplayOptionsGreenChannelisOn =
      imageDisplayOptionsGreenChannel.isisOn();
    ...
    Boolean imageDisplayOptionsBlueChannelisOn =
      imageDisplayOptionsBlueChannel.isisOn();
    ...
    Boolean imageDisplayOptionsGreyChannelisOn =
      imageDisplayOptionsGreyChannel.isisOn();
