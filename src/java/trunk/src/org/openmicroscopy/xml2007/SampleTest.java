...
/*
    ...
    String projectOwnerID = projectOwner.getID();
    ...
    String imagePixelsID = imagePixels.getID();
    ...
    String lightSource1ID = lightSource1.getID();
    ...
    String lightSource2ID = lightSource2.getID();
...
*/
  ...
  public static void main(String[] args) throws Exception {
    ...
    org.w3c.dom.Document doc = ome.getDOMElement().getOwnerDocument();
    org.openmicroscopy.xml.DOMUtil.writeXML(System.out, doc);
  }
