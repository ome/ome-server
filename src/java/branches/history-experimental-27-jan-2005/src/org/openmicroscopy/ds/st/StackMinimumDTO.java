/*
 * org.openmicroscopy.ds.st.StackMinimumDTO
 *
 *------------------------------------------------------------------------------
 *
    ...
    implements StackMinimum
{
    ...
    public String getDTOTypeName() { return "@StackMinimum"; }
    public Class getDTOType() { return StackMinimum.class; }
