/*
 * org.openmicroscopy.ds.st.BinaryMaskDTO
 *
 *------------------------------------------------------------------------------
 *
...
public class BinaryMaskDTO
    extends AttributeDTO
    implements BinaryMask
{
    public BinaryMaskDTO() { super(); }
    public BinaryMaskDTO(Map elements) { super(elements); }

    public String getDTOTypeName() { return "@BinaryMask"; }
    public Class getDTOType() { return BinaryMask.class; }
