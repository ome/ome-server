/*
 * org.openmicroscopy.ds.st.EdgeDirecHistDTO
 *
 *------------------------------------------------------------------------------
 *
...
public class EdgeDirecHistDTO
    extends AttributeDTO
    implements EdgeDirecHist
{
    public EdgeDirecHistDTO() { super(); }
    public EdgeDirecHistDTO(Map elements) { super(elements); }

    public String getDTOTypeName() { return "@EdgeDirecHist"; }
    public Class getDTOType() { return EdgeDirecHist.class; }
