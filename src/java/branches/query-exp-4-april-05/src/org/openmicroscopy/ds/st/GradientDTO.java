/*
 * org.openmicroscopy.ds.st.GradientDTO
 *
 *------------------------------------------------------------------------------
 *
...
public class GradientDTO
    ...
    implements Gradient
{
    public GradientDTO() { super(); }
    public GradientDTO(Map elements) { super(elements); }

    public String getDTOTypeName() { return "@Gradient"; }
    public Class getDTOType() { return Gradient.class; }
