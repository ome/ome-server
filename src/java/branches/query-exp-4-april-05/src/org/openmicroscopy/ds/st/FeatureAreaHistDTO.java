/*
 * org.openmicroscopy.ds.st.FeatureAreaHistDTO
 *
 *------------------------------------------------------------------------------
 *
...
public class FeatureAreaHistDTO
    extends AttributeDTO
    implements FeatureAreaHist
{
    public FeatureAreaHistDTO() { super(); }
    public FeatureAreaHistDTO(Map elements) { super(elements); }

    public String getDTOTypeName() { return "@FeatureAreaHist"; }
    public Class getDTOType() { return FeatureAreaHist.class; }
