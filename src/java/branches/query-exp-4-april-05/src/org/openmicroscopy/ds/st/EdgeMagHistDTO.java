/*
 * org.openmicroscopy.ds.st.EdgeMagHistDTO
 *
 *------------------------------------------------------------------------------
 *
...
public class EdgeMagHistDTO
    extends AttributeDTO
    implements EdgeMagHist
{
    public EdgeMagHistDTO() { super(); }
    public EdgeMagHistDTO(Map elements) { super(elements); }

    public String getDTOTypeName() { return "@EdgeMagHist"; }
    public Class getDTOType() { return EdgeMagHist.class; }
