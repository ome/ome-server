/*
 * org.openmicroscopy.ds.st.PlaneCentroidDTO
 *
 *------------------------------------------------------------------------------
 *
    ...
    implements PlaneCentroid
{
    ...
    public String getDTOTypeName() { return "@PlaneCentroid"; }
    public Class getDTOType() { return PlaneCentroid.class; }
