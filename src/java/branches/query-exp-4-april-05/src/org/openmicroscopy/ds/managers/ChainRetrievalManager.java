/*
 * org.openmicroscopy.ds.managers.ChainRetrievalManager
 *
 *------------------------------------------------------------------------------
 *
...
public class ChainRetrievalManager
    extends AbstractService
{
    ...
    public ChainRetrievalManager() { super(); }
     ...
     */
    public ChainRetrievalManager(RemoteCaller caller)
    {
        super();
    ...
    /**
     * Retrieve all of the chains in the database
     * @return A list of analysis chain objects, including nodes 
     * 		(with modules), with links (formal inputs and outputs, and 
     * 		semantic types.
     */
    public List retrieveChains() {
        return icaller.dispatchList(AnalysisChain.class,"retrieveChains",
        			null);
    }
}